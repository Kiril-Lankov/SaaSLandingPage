...
const Header = () => {
    ...
    return (
        <header className='fixed top-0 left-0 z-50 w-full py-10'>
            <div className='continer flex h-14 items-center max-lg:px-5'>
            ...
            <div className= {clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0',
                isOpen ? 'max-lg:opacity-100' : 'max-lg:events:none'
            )}>
                <div className='max-lg:relative max-lg:flex
                max-lg:flex-col max-lg:min-h-screen max-le:p-6 max-lg:overflow-hidden
            ...
            <button className='lg:hidden z-2
             size-10 border-2 border-s4/25
            rounded-full flex 
